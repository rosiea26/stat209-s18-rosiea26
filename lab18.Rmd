...
**Answer**: The numbers are close but not identical; 56937.61 versus 56938
...
**Answer**: No, because there are outliers on either end of the pay spectrum, some nearer to 0 and many above 60000 (around 65000) that affect the mean value.
...
**Answer**: Yes, the numbers are very similar, varying by approximately 1000.
...
**Answer**: There is an 80% probability that the true mean for the age of murdered people in London is 33.86 years old or in the range from 33.07-34.65 years old.
